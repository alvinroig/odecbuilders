        ...
        <link href="css/multi_step.css" rel="stylesheet" type="text/css" />
    ...
    function validate_form()
        ...
        $('#')
            if($('#sched input[type=checkbox]:checked').length < 15)
            {
                alert ( "Please select at least 15 checkbox in the schedule" );
    ...
    <script>
    function validate_sched()
        {
        valid = true;

        $('#')
            if($('#sched input[type=checkbox]:checked').length < 1)
            {
