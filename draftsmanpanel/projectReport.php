                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class ="box-title"><i class="fa fa-clipboard"></i> Projects Report &nbsp; <a href="pdf/proj_reports_all.php" target="_blank"><button class="btn btn-success btn-sm"><i class="fa fa-file-o"></i> View PDF</button></a></h3>
                                </div>
                                    <div class="box-body table-responsive">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th colspan="1" rowspan="1"><i class="fa fa-check-square-o"></i> Skill</th>
                                                <th colspan="1" rowspan="1"><i class="fa fa-compass"></i> Location</th>
                                                <th colspan="1" rowspan="1"><i class="fa fa-bookmark"></i> Status</th>
                                                <th colspan="1" rowspan="1"><span class="glyphicon glyphicon-stats"></span> Logs</th>

                                        </thead>
                                        <tbody>
                                           <?php echo $db -> fetchProjectReport($id) ?>
