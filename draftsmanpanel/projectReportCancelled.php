                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class ="box-title"><i class="fa fa-clipboard"></i> Cancelled Projects <a href="pdf/proj_reports_cancelled.php" target="_blank"><button class="btn btn-success btn-sm"><i class="fa fa-file-o"></i> View PDF</button></a></h3>
                                </div>
                                    <div class="box-body table-responsive">
                                        ...
                                        <tbody>
                                           <?php echo $db -> fetchProjectReportCancelled($id) ?>
